 ...
 * @method static $this|Builder where(string|array|\Closure $column, string $operator = null, mixed $value = null, string $boolean = 'and') Find a model by its primary key.
 ...
 * @method static \Illuminate\Database\Query\Builder|static whereIn(string $column, mixed $values, string $boolean = 'and', bool $not = '') Find a model by its primary key.
 ...
 * @method static \Illuminate\Database\Query\Builder|$this whereNull(string $column, string $boolean = 'and', bool $not = '') Find a model by its primary key.
